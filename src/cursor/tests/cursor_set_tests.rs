...
fn single_cursor_to_move_up_bug_1() {
    ...
    // DO NOT break this test into 3 smaller ones, the bug was in "forgetting" preferred target column
    // and coding/decoding erases this information assert_eq!(apply("asdf\nasd\n\ndsafsdf\nfdsafds#"
    // , f), "asdf\nasd\n\ndsafsdf#\nfdsafds"); assert_eq!(apply("asdf\nasd\n\ndsafsdf#\nfdsafds",
    // f), "asdf\nasd\n#\ndsafsdf\nfdsafds"); assert_eq!(apply("asdf\nasd\n#\ndsafsdf\nfdsafds", f),
    // "asdf\nasd#\n\ndsafsdf\nfdsafds");
