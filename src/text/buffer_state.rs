...
impl BufferState {
    ...
    */
    // TODO fuzzy that invariant: false => unchanged
    // TODO maybe, just maybe, these stupid messages should go to CEM, not sure. Because moving them out
    // already made me forgot about updating navcomp and updating treesitter.
